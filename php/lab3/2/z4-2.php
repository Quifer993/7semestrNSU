...
if(isset($align) && isset($valign)){
    print "<table style='table-layout: fixed' align='center'>\n";
    print   "<tr>
                <td class='temp' style='text-align: $align; vertical-align: $valign;'>
                    Текст
                </td>
            </tr>";
    print "</table>";
...
<form action="<?php print $_SERVER['PHP_SELF']; ?>" method="GET" style="text-align: center">
